 ...
 * - Makes it easy to swap data sources (change from API to database without changing business logic)
 * 
 * GENERIC TYPE <T>:
...
public interface Repository<T> {
     ...
     * 
     * Example: repository.getObject(5) might return the 5th cocktail or cocktail with ID 5
     */
